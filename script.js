...
*/
const memoryCards = [
    { photo: 'photos/test1.webp', emoji: '🌊', caption: 'Our first memory together 🩵', label: 'Memory 1' },
    { photo: '', emoji: '🩵', caption: 'A moment I will never forget',       label: 'Memory 2' },
    { photo: '', emoji: '❄️', caption: 'You looked so happy here',           label: 'Memory 3' },
    { photo: '', emoji: '💙', caption: 'This one makes me smile',            label: 'Memory 4' },
    { photo: '', emoji: '✨', caption: 'Grateful for this day',              label: 'Memory 5' },
    { photo: '', emoji: '💎', caption: 'One of my favorites of us',         label: 'Memory 6' },
];
